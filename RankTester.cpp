...
//    }
    RankTree<ThreeParamKey, int> tree = RankTree<ThreeParamKey, int>();
    /*
     * 1,1,1
     * 1,1,2
     * 1,2,3
     ...
     *
     */
    ThreeParamKey key = ThreeParamKey(1,1,1);
    ThreeParamKey key2 = ThreeParamKey(1,1,2);
    ThreeParamKey key3 = ThreeParamKey(1,2,3);
    ThreeParamKey key4 = ThreeParamKey(2,2,5);
    ThreeParamKey key5 = ThreeParamKey(5,3,2);
    ThreeParamKey key6 = ThreeParamKey(6,3,1);
    ThreeParamKey key7 = ThreeParamKey(4,4,4);
    ThreeParamKey key8 = ThreeParamKey(1,3,3);
    tree.Insert(key, new int(1));
    tree.Insert(key2, new int(2));
    tree.Insert(key3, new int(3));
    tree.Insert(key4, new int(5));
    tree.Insert(key5, new int(2));
    tree.Insert(key6, new int(1));
    tree.Insert(key7, new int(4));
    tree.Remove(key5);
    //tree.Insert(key, new int(1));

    ThreeParamKey search6 = tree.FindByRank(6);
    ThreeParamKey search1 = tree.FindByRank(1);
    ThreeParamKey search5 = tree.FindByRank(5);
    ThreeParamKey search3 = tree.FindByRank(3);
    ThreeParamKey search0 = tree.FindByRank(0);
    ThreeParamKey search4 = tree.FindByRank(4);
    ThreeParamKey search2 = tree.FindByRank(2);
    tree.GetRoot();
    return 0;
}
